  ...
  return (
    <div className=' px-4 lg:px-0 flex lg:flex justify-between items-center max-w-[1240] mx-auto py-4 text-black'>
       <ul className=' lg:flex md:flex hidden text-sm w-full hover:text'> 
            <li className='p-2 lg:p-4 '><a href='#' className='nav-link'>Home</a></li>
            <li className='p-2 lg:p-4'><a href='#' className='nav-link'>About Us</a></li>
            <li className='p-2 lg:p-4'><a href='#' className='nav-link'>Services</a></li>
            <li className='p-2 lg:p-4'><a href='#' className='nav-link'>Contact Us</a></li>
        </ul>
